...
[JsonObject(MemberSerialization.OptIn), Table(Name = "rba.v_user_role_all_info", DisableSyncStructure = true)]
public partial class V_UserRoleAllInfo : IEntity
{

  [JsonProperty, Column(Name = "app_Desc", DbType = "varchar(100)")]
  ...
  [JsonProperty, Column(Name = "approver_last_name", DbType = "varchar(50)", IsNullable = false)]
  ...
  [JsonProperty, Column(Name = "expr1", DbType = "varchar(50)", IsNullable = false)]
  ...
  [JsonProperty, Column(Name = "requester_email", DbType = "varchar(100)")]
  public string? Requester_Email { get; set; }

  [JsonProperty, Column(Name = "requester_first_name", DbType = "varchar(50)", IsNullable = false)]
  public string? Requester_First_Name { get; set; }

  [JsonProperty, Column(Name = "requester_last_name", DbType = "varchar(50)", IsNullable = false)]
