...
public interface IVUserRolePlantRepository : IRepositoryBase<V_UserRolePlant>
{
  ...
  Task<IEnumerable<V_UserAvailableRole>> GetAllUserAvailableRolesAsync(string user_cd, string app_code);

  Task<IEnumerable<V_RequestByOwner>> GetRequestByOwnerAsync(string owner_cd);
